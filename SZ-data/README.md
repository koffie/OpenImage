This folder contains code and data from the paper "Modular curves of prime-power level with infinitely many rational points" by Andrew Sutherland and David Zywina.
